...
class RawClientUDP:
    ...
    def send_out_packet(self):
        ...
        :return: None
        """
        self.raw_socket.sendto(self.packet, (self.dest_ip, self.dest_port))
    ...
    def craft_udp_header(self):
        ...
        :return: None
        """
        udp_length = 8 + len(self.msg)
        udp_header = pack('!HHHH', self.source_port, self.dest_port, udp_length, 0)
        ...
        pseudo_header = pack('!4s4sBBH', source_address, dest_address, placeholder, protocol, udp_length)
        pseudo_header = pseudo_header + udp_header + self.msg

        udp_checksum = self.calculate_checksum(pseudo_header)
        udp_header = pack('!HHHH', self.source_port, self.dest_port, udp_length, udp_checksum)
